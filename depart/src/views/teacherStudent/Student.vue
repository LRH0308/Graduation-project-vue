    ...
    <el-card>
      <template #header>
        <div class="card-header">
          <span>学生管理</span>
          <el-button type="primary" @click="getStudentList" :loading="loading">
      ...
      <el-table :data="studentList" v-loading="loading" border stripe>
        ...
        <el-table-column prop="graduationTime" label="毕业届次" width="100" />
...
import { studentApi } from '@/utils/apiRequest'
